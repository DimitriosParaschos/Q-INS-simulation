...
Interactive 3D dead-reckoning simulation comparing classical and quantum-enabled inertial sensors under GNSS-denied conditions — companion code to the paper **"Quantum Sensing Technologies for Inertial Navigation: A State-of-the-Art Review and Comparative Drift Simulation Framework"** (D. Paraschos, N. K. Papadakis, Hellenic Army Academy).
...
@article{paraschos_papadakis_quantum_ins,
  title   = {Quantum Sensing Technologies for Inertial Navigation: A State-of-the-Art Review and Comparative Drift Simulation Framework},
